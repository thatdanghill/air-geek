...
urlpatterns = patterns('',
    ...
    url(r'^(?P<project_name>[\w\-]+)/news/$', views.news, name="News"),
    url(r'^(?P<project_name>[\w\-]+)/forecast-cal-summary/$', views.forecastCalSummary, name="Forecast Summary - Calendar Year"),
    # url(r'^(?P<project_name>[\w\-]+)/forecast/forecast-cal/$', views.forecastCal, name="Forecast Summary - Calendar Year"),
    # url(r'^(?P<project_name>[\w\-]+)/forecast/forecast-fin/$', views.forecastFin, name="Forecast Summary - Financial Year"),
